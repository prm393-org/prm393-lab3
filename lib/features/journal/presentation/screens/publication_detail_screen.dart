...
import '../viewmodels/publication_detail_state.dart';
import '../viewmodels/publication_detail_viewmodel.dart';
  ...
  void initState() {
    ...
    Future.microtask(
      () => ref
          ...
          .load(workId: widget.workId, preview: widget.preview),
    );
  }

  @override
  Widget build(BuildContext context) {
    final state = ref.watch(publicationDetailViewModelProvider);
    final retry = ref.read(publicationDetailViewModelProvider.notifier).retry;

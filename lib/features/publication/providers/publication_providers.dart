...
final publicationRemoteDatasourceProvider =
...
final getJournalsByTopicProvider = Provider<GetJournalsByTopic>(
  (ref) => GetJournalsByTopic(ref.watch(publicationRepositoryProvider)),
);

final getJournalByIdProvider = Provider<GetJournalById>(
  (ref) => GetJournalById(ref.watch(publicationRepositoryProvider)),
);

final getWorksByJournalProvider = Provider<GetWorksByJournal>(
